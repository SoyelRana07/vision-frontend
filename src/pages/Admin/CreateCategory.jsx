  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://vision-backend-328443733915.asia-south2.run.app/api/v1/category/create-category",
        { name, parent },
        {
          headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const { data } = await axios.put(
        `https://vision-backend-328443733915.asia-south2.run.app/api/v1/category/update-category/${selected._id}`,
  ...
  const handleDelete = async (categoryId) => {
    try {
      const { data } = await axios.delete(
        `https://vision-backend-328443733915.asia-south2.run.app/api/v1/category/delete-category/${categoryId}`,
        {
          headers: {
            Authorization: auth?.token,
          },
